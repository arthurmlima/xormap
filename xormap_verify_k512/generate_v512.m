% generate_v512.m
% Same generator as ../xormapverilog/Genv_xormap.m, just parameterized to
% K=512 and writing into this folder instead of xormapverilog/.
...
filename = fullfile(this_dir, sprintf('xormap_%d.v', K));
